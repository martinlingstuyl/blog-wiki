...
![Alerts preview](https://user-images.githubusercontent.com/13972467/157928930-b08f55f4-dc12-46d5-b637-ecbf67daa833.png)
...
1. In the Markdown file for your post, insert the following shortcode:
   ...
   ```markdown
   {{< youtube your-youtube-code >}}
   ```
   And replace `your-youtube-code` with the code you copied in the previous step.
 
> Note that, when using Visual Studio Code to edit this repository, you can use the `youtube` or `short-youtube` snippets to automatically insert the YouTube shortcode.


## Podbean

To embed a Podbean podcast, follow these steps:

1. From the Podbean episode page, select the **Share** option:

   ![The Share option in Podbean](https://user-images.githubusercontent.com/13972467/157933067-6ea4dc8a-b40a-414f-82ba-887b64add3db.png)
